	...
	$.extend(awxUI, {
		...
		buildUI: function() {
			$('body').append('<div id="preload">' +
							...
							'</div>' + 
							'<div id="content">' +
							'<div id="displayoverlay"><div id="controls"></div><div id="artwork"><img class="discThumb" src="images/blank_cdart.png" style="width: 194px; height: 194px; position: absolute; z-index: -1;"><img class="artThumb" src="images/thumbPoster.png"></div><div><div id="volumeSlider"></div><img src="ui.uni/images/volume.png"></div><div class="playingSliderWrapper"><div class="playingSlider"></div></div></div>' +
							'</div>' +
							'<div id="footer">' +
